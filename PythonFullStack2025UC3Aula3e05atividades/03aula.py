...
def abrir_excel(nome_arquivo):
    """Abre o arquivo Excel usando o programa padrão do sistema."""
    ...
    if sistema_operacional == "Windows":
        ...
        print(f"Sistema operacional '{sistema_operacional}' não suportado para abertura automática.")
...
def main():
    ...
    while True:
        ...
        if opcao == '1':
            ...
            print("Saindo e abrindo o arquivo Excel...")
            break
        elif opcao == '5':
    ...
    abrir_excel(NOME_ARQUIVO_EXCEL)
